      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 lg:grid-cols-2 lg:items-center lg:py-28">
        ...
        >
          ...
          <div className="mt-6 space-y-4 text-base leading-relaxed text-background/80">
            <p>
              Mãe é colo, é cheiro de casa, é abraço apertado de domingo. A <strong>Liquida Perfumes</strong>, <strong>O Boticário</strong> e <strong>Eudora</strong> se uniram para transformar esse sentimento em fragrância — o aroma que traz tudo de volta: a infância, o cuidado, o amor sem palavras.
            </p>

...
export const KITS: Kit[] = [
  ...
  { id: "k16", slug: "cuide-se-bem-pessegura", nome: "Kit Cuide-se Bem Pessegura", marca: "O Boticário", descricao: "Loção hidratante + body spray com aroma frutal de pêssego.", preco: 54.99, precoOriginal: 74.99, imagem: "https://www.boticario.com.br/on/demandware.static/-/Sites-boticario-master-catalog/default/dw10d5e5e3/Imagens_Produtos/B53770/B53770_1.jpg", badge: "Mega Promoção" },
];

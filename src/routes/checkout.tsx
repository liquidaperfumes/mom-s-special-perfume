          ...
          <div className="rounded-2xl sm:rounded-[2rem] border border-border bg-card p-5 shadow-premium sm:p-8">
            ...
            <div className="mt-8 flex flex-col items-center gap-4">
              ...
              <div className="flex items-center justify-center gap-5 opacity-80">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Logo_Pix.png/512px-Logo_Pix.png" alt="Pix" className="h-5 object-contain" />
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/512px-Mastercard-logo.svg.png" alt="Master" className="h-5 object-contain" />
              </div>
            </div>
          </div>
        </aside>

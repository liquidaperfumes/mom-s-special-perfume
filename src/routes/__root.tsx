...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Líquida Perfumes — Dia das Mães 2026" },
      ...
      { property: "og:description", content: "Líquida Perfumes — Dia das Mães 2026" },
      { name: "twitter:description", content: "Líquida Perfumes — Dia das Mães 2026" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a44012e9-0ebd-493d-846c-84e281f4372e" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/a44012e9-0ebd-493d-846c-84e281f4372e" },
